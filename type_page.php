                                 ...
                                 <?php 
                                        ...
                                        while($res = mysql_fetch_array($q))
                                        {
                                            ...
                                            if($i%2==0)
                                            {
                                                    echo '
                                                    <li>
                                                    <div class="timeline-badge '.$class_type.' " ><i class="fa '.$type_image.'"></i></div>
                                                        <div class="timeline-panel">
                                                            <div class="timeline-heading">
                                                                <h4 class="timeline-title">'.$res['title'].'</h4>
                                                                <p><small class="text-muted"><i class="fa fa-clock-o"></i> Дата публикации '.$res['date'].'</small></p>
                                                            </div>
                                                            <div class="timeline-body">
                                                                <p>'.$res['summary'].'           <a href="full.php?id='.$res['id'].'">Подробнее...</a></p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                ';
